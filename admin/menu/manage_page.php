    ...
    if($page>-1){
                        ...
                        onclick=\"if(document.getElementById('span_0').value=='asc'){alert(document.getElementById('span_0').value);
                        location.href='./manage.html?page=$page&sortByNum=asc';}else{alert(document.getElementById('span_0').value);location.href='./manage.html?page=$page&sortByNum=desc';}\">번  호</span> 
