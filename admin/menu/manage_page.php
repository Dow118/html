    ...
    if($page>-1){
                        ...
                        onclick=\"if(this.value=='asc'){alert(this.value);
                        location.href='./manage.html?page=$page&sortByNum=asc';}else{alert(this.value);location.href='./manage.html?page=$page&sortByNum=desc';}\">번  호</span> 
