    ...
    if($page>-1){
                        ...
                        echo "<table class='type03'><tr><th>번  호</th><th>아티스트</th><th>곡  명</th><th>주소값</th><th>장 르</th><th>등록일자</th></tr>";
                          ...
                          echo "<td class='button'><input type='submit' value='delete' id='submitbutton'></td>";
                          echo "</form>";
                          echo "<form method='POST' action = './modify.html'>";
                          echo "<input type='hidden' name='key' value='$row[0]'>";
                          echo "<td class='button'><input type='submit' value='modify' id='submitbutton'/></td>";
                          echo "</form></tr><br>";
                          }
                        echo "</table>";
    }
