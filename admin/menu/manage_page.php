    ...
    if($page>-1){
	 ...
	 plain.style.display='';test.innerText='번  호▲';}else{plain.style.display='none';test.innerText='번  호▼';}\">번  호▼</span><div id='plain' style='display: none'><HR> <input type='checkbox'>오름차순<input type='checkbox'>내림차순<HR></div></th><th>아티스트</th><th class='large'>곡  명</th><th>주소값</th><th class='small'>장 르</th><th>등록일자</th></tr>";
