<?php
    ...
    if($page>-1){
                        ...
                        echo "<table class='type03' style='table-layout:fixed'><tr class='row'><th class='small'>
                                ...
                                <span class='option' onmousemove=\"arrowbox_move(102)\" onclick=this.nextSibling.nextSibling.style.display=(this.nextSibling.nextSibling.style.display=='none')?'block':'none'; >▼</span><p class='arrow_box' id='102'>아티스트 필터링</p><div class='option_hidden'>";
                        ...
                        <input type='submit' class='optionbutton' name='filterByArtist' value='null'>
                                ...
                                <span class='option' onmousemove=\"arrowbox_move(105)\" onclick=this.nextSibling.nextSibling.style.display=(this.nextSibling.nextSibling.style.display=='none')?'block':'none'; >▼</span><p class='arrow_box' id='105'>장르 필터링</p><div class='option_hidden'>";
