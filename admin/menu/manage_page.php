<?php
    ...
    if($page>-1){
                        ...
                        $result = mysqli_query($connect, $query_result);
                          ...
                          echo "<td><input type='submit' value='delete'  class='button' id='action_delete' src='/imgsrc/delete.png'></td>";
                          echo "</form>";
                          echo "<form method='POST' action = './modify.html'>";
                          echo "<input type='hidden' name='key' value='$row[0]'>";
                          echo "<td><input type='submit' value='modify'  class='button' id='action_modify' src='/imgsrc/edit.png'></td>";
                          echo "</form></tr>";
                          }
                        echo "</table>";
    }
