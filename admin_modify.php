...
$result = mysqli_query($connect,"update info set song_artist='$_POST[song_artist]', song_name='$_POST[song_name]',
 song_url='$_POST[song_url]', song_category='$_POST[song_category'] where song_no='$_POST[song_no]'");
